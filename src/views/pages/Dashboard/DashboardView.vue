  ...
  <div class="container-xl px-4 mt-4">
    ...
    <ul class="nav nav-tabs">
      <li class="nav-item">
        <a
          @click="nav_index = 0"
          :class="{ 'nav-link': true, active: nav_index === 0 }"
          href="#"
          >PROFILE</a
        >
      </li>
      <li class="nav-item">
        <a
          @click="nav_index = 1"
          :class="{ 'nav-link': true, active: nav_index === 1 }"
          href="#"
          >AMI(E)S</a
        >
      </li>
      <li class="nav-item">
        <a
          @click="nav_index = 2"
          :class="{ 'nav-link': true, active: nav_index === 2 }"
          href="#"
          >STATS</a
        >
      </li>
              ...
              <div>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <button class="dropdown-item btn btn-link text-primary">
                        Jouer
                      </button>
                    </li>
                    <li>
                    ...
                    <li>
                      <button class="dropdown-item btn btn-link text-danger">
                        Supprimer
                      </button>
                    </li>
                  </ul>
        ...
        <div class="card mb-4 mb-xl-0">
          ...
          <div class="card-body text-center">
            ...
            <div style="height: 200px">
              <img
                class="w-75 h-100 rounded-circle mb-2"
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form>
              ...
              <div class="row mb-5">
                <div class="col">
                  <label class="small mb-1" for="inputBiography"
                    >BIOGRAPHY</label
                  >
                  <textarea
                    class="form-control"
